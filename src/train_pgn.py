...
def process_game(pgn_text):
    ...
    while n is not None:
        ...
        initial_pos = chess.square_rank(n.move.from_square) - 1, chess.square_file(n.move.from_square) - 1
        final_pos = chess.square_rank(n.move.to_square) - 1, chess.square_file(n.move.to_square) - 1
